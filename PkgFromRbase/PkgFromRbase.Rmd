...
- build or install the two versions of R in separate directory trees and
  ...
  in https://support.rstudio.com/hc/en-us/articles/215488098-Installing-multiple-versions-of-R-on-Linux ;
...
elements in that file needed for a package such as `nlspkg`, but at the
