...
"Gigabytes", or GB, may be $1000^3$ or $1024^3$ bytes. ?? AB? Is that correct?
...
Colin Gillespie, the author, for making  
corrections in version 1.0.8, based on communications with one of us (AB). 
