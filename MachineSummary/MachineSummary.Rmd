...
function of this package for some Windows 10 versions. It has been 
corrected in the latest version 1.0.8, with contributions from one of the authors (AB).

<!-- on https://github.com/csgillespie/benchmarkme, but at the -->
...
This is a port(??part) of Mike Malcolm's ENVRON to R. ??ref. It computes the 
