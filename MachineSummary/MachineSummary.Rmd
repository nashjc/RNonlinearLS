...
(see https://en.wikipedia.org/wiki/Gigabyte) there is a movement to use, for example, Gigabyte or GB to mean usits of 1000^3 bytes, while the Gigibyte or Gib is 1024^3.
