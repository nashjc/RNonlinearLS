...
variety could be an instructive subject for numerical software designers.
...
with respect to the (scalar) parameter $\alpha$. That one-dimensional minimization can
...
but such code is generally quite involved.
...
There have been many proposed approaches to nonlinear least squares. The following
...
line-search minimization. Jones mentions matrix inversion, and it is not clear whether
...
as far as I can determine, have a reasonable basis.
...
?? MaxLik?? others -- Charles Geyer 

https://www.stat.umn.edu/geyer/trust/

CRAN trust package??

?? had something for exponential models??
