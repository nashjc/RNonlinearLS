...
has elements $\sqrt {(\lambda)}$ times the square roots of the 
diagonal stabilization elements
...
as well as the `rjfun()` generated by `nlsr::model2rjfun()`. On the other hand, 
