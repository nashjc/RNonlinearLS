...
This reveals that the time for summing 100 elements is much longer than that
...
by the size of the vector. Thus we are suspicious that R is trying to compile
the functions "on the fly" and this may be taking time when the program
is initiated. Timings in microseconds were run on a machine with the profile (@RMachID2022)
