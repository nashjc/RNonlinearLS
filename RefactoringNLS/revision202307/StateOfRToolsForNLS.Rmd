...
are available on the CRAN repository. Of these, we will pay particular 
...
stopping early. This may cause overly long run-times for `nlsr`.
...
specify where the solution will be, and we hope the solution is complicated
...
too frequently and unnecessarily with `singular gradient` errors. Successful
...
There are problems where use of R will be slower. For example, a
