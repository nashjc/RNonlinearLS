...
\urlstyle{same}
\hypersetup{
  pdftitle={The Current State of R Tools for Nonlinear Least Squares Modeling},
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# for nlsLM}
\ControlFlowTok{if}\NormalTok{ (}\FunctionTok{inherits}\NormalTok{(tnlm1, }\StringTok{"try{-}error"}\NormalTok{))  \{}
   \FunctionTok{print}\NormalTok{(}\StringTok{"Cannot compute solution {-}{-} likely singular Jacobian"}\NormalTok{)}
\NormalTok{ \} }\ControlFlowTok{else}\NormalTok{ \{  }
\NormalTok{   JtnlsLM }\OtherTok{\textless{}{-}}\NormalTok{ tnlm1}\SpecialCharTok{$}\NormalTok{m}\SpecialCharTok{$}\FunctionTok{gradient}\NormalTok{() }\CommentTok{\# actually the Jacobian}
   \FunctionTok{svd}\NormalTok{(JtnlsLM)}\SpecialCharTok{$}\NormalTok{d }\CommentTok{\# Singular values}
\NormalTok{\}   }
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# for gsl\_nls}
\ControlFlowTok{if}\NormalTok{ (}\FunctionTok{inherits}\NormalTok{(tgslnls1, }\StringTok{"try{-}error"}\NormalTok{)) \{}
   \FunctionTok{cat}\NormalTok{(}\StringTok{"Cannot compute solution {-}{-} likely singular Jacobian"}\NormalTok{)}
\NormalTok{\} }\ControlFlowTok{else}\NormalTok{ \{  }
\NormalTok{   JtnlsLM }\OtherTok{\textless{}{-}}\NormalTok{ tgslnls1}\SpecialCharTok{$}\NormalTok{m}\SpecialCharTok{$}\FunctionTok{gradient}\NormalTok{()}
   \FunctionTok{svd}\NormalTok{(JtnlsLM)}\SpecialCharTok{$}\NormalTok{d }\CommentTok{\# Singular values}
\NormalTok{\}   }
\end{Highlighting}
\end{Shaded}
...
\NormalTok{rnowt }\OtherTok{\textless{}{-}}\NormalTok{ nowt}\SpecialCharTok{$}\NormalTok{m}\SpecialCharTok{$}\FunctionTok{resid}\NormalTok{() }\CommentTok{\# This has unweighted residual and Jacobian. Does not take coefficients.}
\FunctionTok{attr}\NormalTok{(rnowt, }\StringTok{"gradient"}\NormalTok{) }\OtherTok{\textless{}{-}} \ConstantTok{NULL}\NormalTok{; rnowt}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{rusewt }\OtherTok{\textless{}{-}}\NormalTok{ usewt}\SpecialCharTok{$}\NormalTok{m}\SpecialCharTok{$}\FunctionTok{resid}\NormalTok{() }\CommentTok{\# weighted. Does not take coefficients.}
\FunctionTok{attr}\NormalTok{(rusewt,}\StringTok{"gradient"}\NormalTok{) }\OtherTok{\textless{}{-}} \ConstantTok{NULL}\NormalTok{; rusewt}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{rn0}\OtherTok{\textless{}{-}}\NormalTok{nmod0}\SpecialCharTok{$}\FunctionTok{resid}\NormalTok{() }\CommentTok{\# Parameters are supplied in nlsModel() \textasciigrave{}start\textasciigrave{} above.}
\FunctionTok{attr}\NormalTok{(rn0,}\StringTok{"gradient"}\NormalTok{) }\OtherTok{\textless{}{-}} \ConstantTok{NULL}\NormalTok{; rn0}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{rn }\OtherTok{\textless{}{-}}\NormalTok{ nmod}\SpecialCharTok{$}\FunctionTok{resid}\NormalTok{()}
\FunctionTok{attr}\NormalTok{(rn,}\StringTok{"gradient"}\NormalTok{) }\OtherTok{\textless{}{-}} \ConstantTok{NULL}\NormalTok{; rn}
\end{Highlighting}
\end{Shaded}
...
\leavevmode\vadjust pre{\hypertarget{ref-FoxHallSchryer1978}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-More1981TUO}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-Rosenbrock1960}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-nlsic-manual}{}}%
