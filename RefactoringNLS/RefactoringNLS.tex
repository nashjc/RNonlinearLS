...
the good performance of \texttt{nls()} on selfStart models.
...
have selfStart models that allow users to explicitly provide values
other than those suggested for the starting parameters.
...
including Jacobian code in the selfStart model code, some of the
deficiencies of the Gauss-Newton algorithm are mitigated. However,
...
Exchanges with Fernando Miguez helped to clarify aspects of selfStart
models and improve package \texttt{nlsr} in that respect.
