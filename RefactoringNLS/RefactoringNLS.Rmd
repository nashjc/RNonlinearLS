...
- to streamline the overall `nls()` infrastructure. By this we
  mean a re-factoring the routines so they are better suited to maintenance of both
...
(e.g., https://towardsdatascience.com/unit-testing-in-r-68ab9cc8d211), as well
as with R package checking tools ?? reference??. ??Other refs.
...
<!-- Trying to trim a lot of words, so am makign reference to package. Is it ready -->
<!-- for others to use? -->
...
<!-- ?? needs more focus of where it may appear. -->
...
- The mixing of R, C and Fortran code was necessary for computational performance in the past.
  Lacking decent  
  developer documentation, programmers now face a lot of work to fix or improve code. 
