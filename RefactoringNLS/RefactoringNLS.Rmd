...
not foresee a resolution for this issue.
...
For `nls()` the concern is demonstrated by a short email correspondence.
...
This was in response to an email to Doug bates on Jun 29, 2021 from John Nash.
...
The project output is available in the Git repository https://github.com/nashjc/RNonlinearLS .
...
of the repository https://github.com/nashjc/RNonlinearLS.
...
- MachineSummary.Rmd: an investigation of ways to report the characteristics
