...
features in separate functions. These two approaches
...
is intended to solve our example problem **Logistic3T**, but found initial 
parameters for `nls()` by using a completely separate solver, then rerunning the
