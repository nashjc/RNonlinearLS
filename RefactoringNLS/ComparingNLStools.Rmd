...
some capsule comments later. Packages outside of CRAN, even if they might be
worthy of review, will not be included here.
...
`nlstools` (@p-nlstools) -- Several tools for assessing the quality of fit of a gaussian nonlinear model are provided.
