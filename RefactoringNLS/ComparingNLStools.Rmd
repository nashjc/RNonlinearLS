...
and `gslnls::gsl_nls()`, which we will call the **class nls** methods.
...
of `selfStart` models, but the construction of them is non-trivial. Their use with
...
errors in the parameters when constraints are active, though we believe this 
worthy of discussion and further investigation.

## Stabilization of Gauss-Newton computations

All four major mentioned must solve some variant of the Gauss-Newton 
