...
\abstract{%
Our Google Summer of Code project ``Improvements to \texttt{nls()}'' considered the features and limitations of the R function \texttt{nls()} with the aim of improving and rationalizing R tools for nonlinear regression. The rich features of \texttt{nls()} are weakened by several deficiencies and inconsistencies such as a lack of stabilization of the Gauss-Newton solver. Further considerations are the usability and maintainability of the code base that provides the functionality \texttt{nls()} claims to offer. Various packages, including our \texttt{nlsr}, provide alternative capabilities. We consider the differences in goals, approaches, and features of different tools for nonlinear least squares modeling in R. Discussion of these matters is relevant to improving R generally as well as its nonlinear estimation tools.
}
...
\texttt{NISTnls} ((\emph{NISTnls: Nonlinear Least Squares Examples from Nist} 2012)) -- This package provides R code and data for a set of
...
\texttt{optimx} (Nash and Varadhan (2011)) -- This provides
...
The Hobbs weed infestation problem (Nash (1979, 120)) is a growth curve modeling
...
\(J' J\) could underflow to zero (Nash (1977)), and a linear combination of both
...
provided. \texttt{nlsr} has antecedents in the methods of Nash (1979), where storage for
...
such as \texttt{nlme} (Pinheiro et al. (2013)), \texttt{bbmle} (Bolker and Team (2013)), and \texttt{lme4} (Bates et al. (2015)) for
...
\hypertarget{refs}{}
\begin{cslreferences}
\leavevmode\hypertarget{ref-R-onls-manual}{}%
...
\leavevmode\hypertarget{ref-BatesWatts81}{}%
...
\leavevmode\hypertarget{ref-minpacklm12}{}%
...
\leavevmode\hypertarget{ref-GSL-manual}{}%
...
\leavevmode\hypertarget{ref-Golub1973}{}%
...
\leavevmode\hypertarget{ref-Huet2004}{}%
...
\leavevmode\hypertarget{ref-Levenberg1944}{}%
...
\leavevmode\hypertarget{ref-Marquardt1963}{}%
...
\leavevmode\hypertarget{ref-MiguezNLRAA2021}{}%
...
\leavevmode\hypertarget{ref-jn77ima}{}%
...
\leavevmode\hypertarget{ref-cnm79}{}%
---------. 1979. \emph{Compact Numerical Methods for Computers: Linear Algebra and Function Minimisation}. Bristol: Adam Hilger.

\leavevmode\hypertarget{ref-NashWires22}{}%
---------. 2022. ``Function minimization and nonlinear least squares in R.'' \emph{WIREs Computational Statistics}, no. e1580. \url{https://doi.org/https://doi.org/10.1002/wics.1580}.

\leavevmode\hypertarget{ref-PkgFromRbase22}{}%
...
\leavevmode\hypertarget{ref-p-optimx}{}%
Nash, John C, and Ravi Varadhan. 2011. \emph{\textup{Optimx}: A Replacement and Extension of the optim() Function}. Nash Information Services Inc.; Johns Hopkins University.

\leavevmode\hypertarget{ref-nash1996nonlinear}{}%
...
\leavevmode\hypertarget{ref-NISTnls-manual}{}%
\emph{NISTnls: Nonlinear Least Squares Examples from Nist}. 2012. \url{https://CRAN.R-project.org/package=NISTnls}.

\leavevmode\hypertarget{ref-OlearyRust13}{}%
...
\leavevmode\hypertarget{ref-nlsmultstart}{}%
...
\leavevmode\hypertarget{ref-p-nlme}{}%
...
\leavevmode\hypertarget{ref-m-nlsmsn}{}%
...
\leavevmode\hypertarget{ref-nlsic-manual}{}%
...
\leavevmode\hypertarget{ref-Torvisco2018}{}%
...
\leavevmode\hypertarget{ref-R-crsnls-manual}{}%
...
\leavevmode\hypertarget{ref-HWtestthat11}{}%
...
\leavevmode\hypertarget{ref-HWdevtools21}{}%
